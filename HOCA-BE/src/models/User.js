...
const userSchema = new mongoose.Schema(
  {
    ...
    // Violation escalation system (auto-punishment)
    violationCount: { type: Number, default: 0 }, // Total confirmed violations
    chatBannedUntil: { type: Date, default: null }, // Temporary chat ban
    roomBannedUntil: { type: Date, default: null }, // Temporary room-creation/join ban
