...
const seedData = async () => {
  try {
    ...
    const configs = [
      {
        key: "minRoomParticipants",
        value: 2,
        description: "Minimum participants per room",
      },
      {
        key: "maxRoomParticipants",
        value: 50,
        description: "Maximum participants per room (Pro users)",
      },
      {
        key: "freeMaxParticipants",
        value: 4,
        description: "Maximum participants for free users",
      },
      {
        key: "freeDailyRoomLimit",
        value: 2,
        description: "Max rooms free users can create per day",
      },
      {
        key: "freeDailyStudyMinutes",
        value: 180,
        description: "Max study minutes per day for free users (3 hours)",
      },
    ];
    ...
    if (!adminExists) {
      ...
      console.log(
        "✅ Created default admin: admin@hoca.com / adminpassword123",
      );
    }
